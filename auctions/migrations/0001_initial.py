# Generated by Django 3.2.9 on 2022-03-08 16:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_price', models.FloatField(default=0, validators=[django.core.validators.MinValueValidator(0, 'Start price must be greater than or equal to 0.')])),
                ...
                ('watchers', models.ManyToManyField(blank=True, null=True, related_name='watchlists', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
